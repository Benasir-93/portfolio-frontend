...
<>
<Navbar/>
<div className="card mb-3 shadow-lg w-75 mx-auto custom-border mt-sm-5">
  <div className="row g-0">
    <div className="col-md-4">
      <img src="./HIJAB profile.png" className="img-fluid rounded-start" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
        <h3 className="card-title mb-4 text-center" style={{color:"#4fa15d"}}  data-aos="fade-right" data-aos-duration="1000">Who I Am</h3>
